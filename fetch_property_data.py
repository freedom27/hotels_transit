...
class TransitCache:
    ...
    def load(self):
        try:
            with open('info_cache.json', 'r') as json_file:
                self.info_cache = json.load(json_file)
        except:
            print('Bad Info Cache File!')
            
        try:
            with open('locations_cache.json', 'r') as json_file:
                self.locations_cache = json.load(json_file)
        except:
            print('Bad Location Cache File!')
    
    def dump(self):
        with open('info_cache.json', 'w') as json_file:
            json.dump(self.info_cache, json_file)
        
        with open('locations_cache.json', 'w') as json_file:
